...
const housingListings = [
  {
    id: 1,
    title: "2BR Apartment Near AUB Main Gate",
    type: "Apartment",
    price: 1250,
    beds: 2,
    baths: 1,
    distance: "8 min walk to AUB",
  ...
  {
    id: 2,
    title: "Shared Hamra Apartment Room",
    type: "Room",
    price: 680,
    beds: 1,
    baths: 1,
    distance: "15 min bike to campus",
  ...
  {
    id: 3,
    title: "Studio in Ras Beirut",
    type: "Studio",
    price: 980,
    beds: 1,
    baths: 1,
    distance: "12 min bus to Bliss Street",
    availability: "Available Now",
    petFriendly: true,
    furnished: false,
  },
  {
    id: 4,
    title: "3BR Furnished Flat in Clemenceau",
    type: "Townhome",
    price: 1600,
    beds: 3,
    baths: 2,
    distance: "10 min drive to AUBMC",
  ...
  {
    id: 5,
    title: "Graduate Student Co-op (AUB Area)",
    type: "Room",
    price: 720,
    beds: 1,
    baths: 1,
    distance: "9 min walk to AUB",
  ...
  },
  {
    ...
    beds: 1,
    baths: 1,
    distance: "14 min bike to campus",
    availability: "Available Now",
    petFriendly: false,
    furnished: false,
  },
  ...
  return (
    <main className="housing-page">
      <header className="housing-header">
        <h1>Housing</h1>
        <p>Browse rentals near the American University of Beirut and filter by type and monthly budget.</p>
      </header>
