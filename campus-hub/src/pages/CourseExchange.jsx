...
const FEATURED_AUB_EXCHANGES = [
  {
    ...
    desiredCourse: "CMPS 271 - Software Engineering (Different section)",
    section: "Looking for a later section",
    status: "Open",
    notes: "Can swap as soon as registrar approval opens.",
  },
  {
    courseExchangeId: "aub-exchange-2",
    currentCourse: "CMPS 211 - Discrete Mathematics (Fatima Abo Salem)",
    desiredCourse: "CMPS 211 - Discrete Mathematics (Any equivalent section)",
    section: "Need to avoid a morning conflict",
    status: "Open",
    notes: "Prefer a section that does not overlap with labs.",
  },
  {
    courseExchangeId: "aub-exchange-3",
    currentCourse: "MUSC 221 - Music Appreciation (Maya Berta Maalouf)",
    desiredCourse: "MUSC 221 - Music Appreciation (Alternative timing)",
    section: "Open to any day combination",
    status: "Open",
    notes: "Looking for a better slot between core courses.",
  },
  {
    ...
    status: "Open",
    notes: "Flexible as long as it stays within EECE 334.",
  },
  {
    ...
    status: "Open",
    notes: "Can coordinate swap directly.",
  },
  {
  ...
  },
  {
    ...
    section: "Seeking section with no overlap on Mondays",
    status: "Open",
